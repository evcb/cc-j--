...
/**
 * Parser generated by JavaCC. It parses a j-- compilation unit (program file),
 * taking tokens from the scanner (also generated by JavaCC), and produces an
...
class JavaCCParser implements JavaCCParserConstants {
  ...
  private AmbiguousName ambiguousPart(TypeName name) {
    ...
    return lastDotIndex == -1 ? null // It was a simple name
  ...
  /**
   * Recover from the parser error that occurred by skipping to any of the
   * specified tokens.
   *
   * Current error recovery mechanism is rather simple-minded and is based on
   * skipping all the tokens until a SEMI or an EOF is encountered. This scheme
   * can be enhanced by passing in the FOLLOW-SET of the non-terminal at hand.
   *
   * @param skipTo array of tokens that we could skip to.
   * @param e      exception that is raised by JavaCC in the event of a parser
   *               error.
   */
    ...
    try {
      ...
      case SUPER:
        ...
        case DOT:
          ...
          expr = new JFieldSelection(line, newTarget, token.image);
          switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
          case LPAREN:
            args = arguments();
            expr = new JMessageExpression(line, newTarget, null, token.image, args);
            break;
          default:
            jj_la1[45] = jj_gen;
            ;
  ...
  final private boolean jj_3R_108() {
    ...
    if (jj_3R_109())
      jj_scanpos = xsp;
    if (jj_scan_token(RCURLY))
      return true;
    return false;
  }

  final private boolean jj_3R_90() {
    if (jj_scan_token(CHAR_LITERAL))
      return true;
    return false;
  }
  ...
  private static void jj_la1_0() {
    jj_la1_0 = new int[] { 0x100000, 0x8000, 0x2e00480, 0x2e00080, 0x2e00080, 0x1000, 0x22e20380, 0x20020300, 0x0,
        0x20300, 0x5d0e6300, 0x5d0c6000, 0x1c0c2000, 0x5d0c6000, 0x0, 0x20300, 0x0, 0x0, 0x1c0c2000, 0x0, 0x1c0c2000,
        0x0, 0x1c0c2000, 0x20300, 0x20300, 0x0, 0x0, 0x20300, 0x0, 0x0, 0x0, 0x0, 0x10000, 0x10000, 0x0, 0x0, 0x0,
        0x1c0c2000, 0x0, 0x1c0c2000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1c0c2000, 0x20300, 0x0, 0x0, 0x0,
        0x10082000, };
  }

  private static void jj_la1_1() {
    jj_la1_1 = new int[] { 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x90000000, 0x90000000, 0x90000000,
        0x90000000, 0x0, 0x0, 0x0, 0x1000000, 0x90000000, 0x0, 0x90000000, 0x0, 0x90000000, 0x0, 0x0, 0x0, 0x0, 0x0,
        0x1000000, 0x1000000, 0x20000000, 0x4000000, 0x48000000, 0x48000000, 0x800000, 0x800000, 0x0, 0x90000000,
        0x80000000, 0x0, 0x0, 0x2000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, };
  }

  private static void jj_la1_2() {
    jj_la1_2 = new int[] { 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x20000000, 0x0, 0x28000001, 0x28000001, 0x8000001,
        0x28000001, 0x0, 0x0, 0x0, 0x0, 0x28000001, 0x0, 0x28000001, 0x0, 0x8000001, 0x0, 0x0, 0x80000000, 0x80000000,
        0x0, 0x2, 0x2, 0x0, 0x0, 0x0, 0x0, 0x1, 0x1, 0x4, 0x8000001, 0x0, 0x8000000, 0x80000000, 0x0, 0x8000000,
        0x80000000, 0x8000000, 0x8000000, 0x8000000, 0x8000000, 0x8000000, 0x0, 0x20000000, 0x8000000, 0x80000000,
        0x0, };
  }

  private static void jj_la1_3() {
    jj_la1_3 = new int[] { 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x20, 0x20, 0x2, 0x20, 0xe22, 0xe22, 0xe20, 0xe22, 0x4, 0x20,
        0x4, 0x0, 0xe20, 0x4, 0xe20, 0x4, 0xe20, 0x0, 0x0, 0x0, 0x0, 0x20, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
        0xe20, 0x0, 0xe20, 0x8, 0x0, 0x0, 0x8, 0x0, 0x0, 0x8, 0x0, 0xe20, 0x20, 0x0, 0x0, 0x0, 0xe00, };
  }
