...
class JClassDeclaration extends JAST implements JTypeDecl {
    ...
    /**
     * Constructs an AST node for a class declaration given the line number, list of
     * class modifiers, name of the class, its super class type, and the class
     * block.
     *
     * @param line            line in which the class declaration occurs in the
     *                        source file.
     * @param mods            class modifiers.
     * @param name            class name.
     * @param superType       super class type.
     * @param implementations class implemented interfaces.
     * @param classBlock      class block.
     */

    public JClassDeclaration(int line, ArrayList<String> mods, String name, Type superType,
            ArrayList<Type> implementations, ArrayList<JMember> classBlock) {
        super(line);
        this.mods = mods;
        this.name = name;
    ...
    /**
     * Checks whether the methods in the interfaces implemented are defined in the
     * class
     */
